...
class MovieCountryTheme extends StatefulWidget {
  const MovieCountryTheme({Key? key}) : super(key: key);

  @override
  State<MovieCountryTheme> createState() => _MovieCountryThemeState();
}

class _MovieCountryThemeState extends State<MovieCountryTheme> {
  @override
...
class MovieCountry extends StatefulWidget {
  const MovieCountry({Key? key}) : super(key: key);

  @override
  State<MovieCountry> createState() => _MovieCountryState();
}

class _MovieCountryState extends State<MovieCountry> {
  bool saveIcon = false;
  int? _selectedIndex;
  @override
  Widget build(BuildContext context) {
