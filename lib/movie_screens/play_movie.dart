...
class PlayMovieTheme extends StatelessWidget {
  const PlayMovieTheme({Key? key}) : super(key: key);
                                                                            ...
                                                                            index == 0
                                                                                ? Padding(
                                                                                    ...
                                                                                    child: SizedBox(
                                                                                      ...
                                                                                      child: GridView.builder(
                                                                                        physics: const NeverScrollableScrollPhysics(),
                                                                                        gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, childAspectRatio: 2.00, mainAxisSpacing: 0, crossAxisSpacing: 5),
                                                                                        itemCount: 9,
                                                                                        shrinkWrap: true,
                                                                                        itemBuilder: (BuildContext context, int index) {
                                                                                          return Column(
                                                                                ...
                                                                                : index == 1
                                                                                    ? Padding(
                                                                                        ...
                                                                                        child: SizedBox(
                                                                                          ...
                                                                                          child: GridView.builder(
                                                                                            physics: const NeverScrollableScrollPhysics(),
                                                                                            gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, childAspectRatio:
                                                                                            2.66, mainAxisSpacing: 0, crossAxisSpacing: 5),
                                                                                            itemCount: 9,
                                                                                            shrinkWrap: true,
                                                                                            itemBuilder: (BuildContext context, int index) {
                                                                                              return Column(
