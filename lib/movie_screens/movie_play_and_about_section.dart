...
class MoviePlayTheme extends StatelessWidget {
  const MoviePlayTheme({Key? key}) : super(key: key);
    ...
    return FutureBuilder<SharedPreferences>(
      ...
      builder: (BuildContext context, AsyncSnapshot<SharedPreferences> snapshot) {
        return ChangeNotifierProvider<MyDynamicTheme>.value(
          ...
          child:  const MoviePlayAndAboutSection(),
        );
      },
    );
  }
...
class MoviePlayAndAboutSection extends StatefulWidget {
  const MoviePlayAndAboutSection({Key? key}) : super(key: key);

  @override
  State<MoviePlayAndAboutSection> createState() =>
      _MoviePlayAndAboutSectionState();
}

class _MoviePlayAndAboutSectionState extends State<MoviePlayAndAboutSection> {
                                    ...
                                    children: <Widget>[
                                      ...
                                      InkWell(
                                        onTap: () {
                                         ...
                                         Navigator.push(context, MaterialPageRoute(builder: (context)=>const MovieInCategoryScreenTheme()));
