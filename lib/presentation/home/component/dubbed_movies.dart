...
import '../../category/component/movie_play_category.dart';

class DubbedmoviesTheme extends StatelessWidget {
  const DubbedmoviesTheme({Key? key}) : super(key: key);
...
class DubbedMovies extends StatefulWidget {
  const DubbedMovies({Key? key}) : super(key: key);

  @override
  State<DubbedMovies> createState() => _DubbedMoviesState();
}

class _DubbedMoviesState extends State<DubbedMovies> {
  bool saveIcon = false;
  int? _selectedIndex;
  @override
  Widget build(BuildContext context) {
                                    ...
                                    child: Stack(
                                      children: [
                                        GestureDetector(
                                          ...
                                          onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>MoviePlayCategoryScreenTheme()));},
                                          child: Container(
