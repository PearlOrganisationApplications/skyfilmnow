...
import 'package:skyfilmnow/movie_screens/play_movie.dart';
import 'package:skyfilmnow/presentation/category/component/category_initial_screen.dart';
import 'package:skyfilmnow/presentation/category/component/movie_in_category.dart';
...
class LastUpdatedMoviesTheme extends StatelessWidget {
  const LastUpdatedMoviesTheme({Key? key}) : super(key: key);
...
class LastUpdatedMovies extends StatefulWidget {
  const LastUpdatedMovies({Key? key}) : super(key: key);

  @override
  State<LastUpdatedMovies> createState() => _LastUpdatedMoviesState();
}

class _LastUpdatedMoviesState extends State<LastUpdatedMovies> {
                          ...
                          children: [
                            index == 0 ? SizedBox(
                              ...
                              child: Row(
                                ...
                                children: const [
                                  Text("All the information about the Movie page",style: TextStyle(color: Colors.grey),textAlign: TextAlign.right,),
                                  SizedBox(
                                    width: 15,
                                  ),
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Positioned(
                                    ...
                                    child: GestureDetector(
                                      onTap: (){
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=>MoviePlayTheme()));
                      },
                                      child: Container(
                                        height:
                                  ...
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        ...
                                        children:   [
                                            Text("All the information about the Movie page",style: TextStyle(color:  showDarkMode ? Colors.white : Colors.blue.shade900),textAlign: TextAlign.right,),
                                          const SizedBox(
                                            width: 5,
                                          ),
