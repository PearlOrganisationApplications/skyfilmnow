...
class LatestSerialsTheme extends StatelessWidget {
  const LatestSerialsTheme({Key? key}) : super(key: key);
...
class LatestSerials extends StatefulWidget {
  const LatestSerials({Key? key}) : super(key: key);

  @override
  State<LatestSerials> createState() => _LatestSerialsState();
}

class _LatestSerialsState extends State<LatestSerials> {
