...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> _containerList( double bottomHeight,double height,double stickerTop,double stickerBottom ) {
          ...
          builder: (BuildContext context,BoxConstraints constraints){
            return  SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ..._containerList(height*0.04,height *0.19,height*0.03,height*0.10),
                  Container(
                      ...
                      children: [
                        ...
                        Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Image(image: const AssetImage("assets/googlee.png",),width: width*0.2,)
                              ],
                            )
                        ),
                        SizedBox(
                        ...
                        Container(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Text("Login with Facebook",style: TextStyle(fontWeight: FontWeight.w500),),
                                SizedBox(
                                  width: width*0.02,
                                ),
                                Image(image: const AssetImage("assets/fb.ico",),width: width*0.1,)
                              ],
                            )
                        ...
                        InkWell(
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>const ForgotEmailPhone()));
                          },
                          child: Align(
