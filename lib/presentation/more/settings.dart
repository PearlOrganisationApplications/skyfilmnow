                            ...
                            child: Row(
                              ...
                              children: [
                                CupertinoSwitch(
                                    ...
                                    value: cupertinoValueAll,
                                    onChanged: (value) => setState(() {
                                          cupertinoValueAll = value;
                                          cupertinoValueSerials =
                                              cupertinoValueAll;
                                          cupertinoValueMovies =
                                              cupertinoValueAll;
                                        })),
                                Container(
                                  width: width * 0.5,
                                  child: Column(
                                    ...
                                    children: const [
                                      ...
                                      Padding(
                                        padding: EdgeInsets.only(right: 10),
                                        child: Text(
                                          "Show all notifications about movies and serials",
                                          textAlign: TextAlign.right,
                              ...
                              children: [
                                CupertinoSwitch(
                                    ...
                                    onChanged: (value) => setState(() {
                                          ...
                                          if (cupertinoValueMovies == false &&
                                              cupertinoValueSerials == false) {
                                  ...
                                  child: Column(
                                    ...
                                    children: const [
                                      ...
                                      Padding(
                                        padding: EdgeInsets.only(right: 10),
                                        child: Text(
                                          "Show all notifications about serials",
                                          textAlign: TextAlign.right,
                                          style: SmallTextStyle.style,
                                        ),
                                      ),
                        ...
                        Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Checkbox(
                                    value: checkBoxValueAskedEveryTime,
                                    onChanged: (value) => setState(() {
                                          checkBoxValueAskedEveryTime = value!;
                                          checkBoxValueWithAppPlayer =
                                              checkBoxValueAskedEveryTime;
                                          checkBoxValueWithMXPlayer =
                                              checkBoxValueWithAppPlayer;
                                        })),
                                const SizedBox(
                                  width: 8,
                        ...
                        Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Checkbox(
                                    value: checkBoxValueWithAppPlayer,
                                    onChanged: (value) => setState(() {
                                          checkBoxValueWithAppPlayer = value!;
                                          if (checkBoxValueWithAppPlayer ==
                                                  false &&
                                              checkBoxValueWithMXPlayer ==
                                                  false) {
                        ...
                        Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Checkbox(
                                    value: checkBoxValueWithMXPlayer,
                                    onChanged: (value) => setState(() {
