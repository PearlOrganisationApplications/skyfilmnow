...
class SeriesPlayCategoryScreenTheme extends StatelessWidget {
  const SeriesPlayCategoryScreenTheme({Key? key}) : super(key: key);
    ...
    return FutureBuilder<SharedPreferences>(
      ...
      builder: (BuildContext context, AsyncSnapshot<SharedPreferences> snapshot) {
        return ChangeNotifierProvider<MyDynamicTheme>.value(
          ...
          child: SeriesPlayCategoryScreen(),
        );
      },
    );
  }
...
class SeriesPlayCategoryScreen extends StatefulWidget {
  const SeriesPlayCategoryScreen({Key? key}) : super(key: key);

  @override
  State<SeriesPlayCategoryScreen> createState() => _SeriesPlayCategoryScreenState();
}

class _SeriesPlayCategoryScreenState extends State<SeriesPlayCategoryScreen> {
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        InkWell(
                                          onTap: () {
                                            Get.to(const SerialInCategoryScreenTheme());
                                          },
                                          child: Icon(
