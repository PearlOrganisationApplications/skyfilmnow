...
import '../../../Serial Screen/serial_about_play_screen.dart';
import '../../../theme_dark_light/change_theme.dart';
import '../../../theme_dark_light/themes.dart';
class BottomMovieSeriesTheme extends StatelessWidget {
  const BottomMovieSeriesTheme({Key? key}) : super(key: key);
    ...
    return FutureBuilder<SharedPreferences>(
      ...
      builder: (BuildContext context, AsyncSnapshot<SharedPreferences> snapshot) {
        return ChangeNotifierProvider<MyDynamicTheme>.value(
          ...
          child: const BottomMoviesSeries(),
        );
      },
    );
  }
...
class BottomMoviesSeries extends StatefulWidget {
  const BottomMoviesSeries({Key? key}) : super(key: key);

  @override
  State<BottomMoviesSeries> createState() => _BottomMoviesSeriesState();
}

class _BottomMoviesSeriesState extends State<BottomMoviesSeries> {
  bool saveIcon = false;
  int? _selectedIndex;
  @override
  Widget build(BuildContext context) {
