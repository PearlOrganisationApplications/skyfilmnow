...
class SerialsTopIMBDTheme extends StatefulWidget {
  const SerialsTopIMBDTheme({Key? key}) : super(key: key);

  @override
  State<SerialsTopIMBDTheme> createState() => _SerialsTopIMBDTheme();
}

class _SerialsTopIMBDTheme extends State<SerialsTopIMBDTheme> {
  @override
...
class SerialTopImbd extends StatefulWidget {
  const SerialTopImbd({Key? key}) : super(key: key);

  @override
  State<SerialTopImbd> createState() => _SerialTopImbdState();
}

class _SerialTopImbdState extends State<SerialTopImbd> {
  bool saveIcon = false;
  int? _selectedIndex;
  @override
  Widget build(BuildContext context) {
