...
class SerialDubbedTheme extends StatefulWidget {
  const SerialDubbedTheme({Key? key}) : super(key: key);

  @override
  State<SerialDubbedTheme> createState() => _SerialDubbedThemeState();
}

class _SerialDubbedThemeState extends State<SerialDubbedTheme> {
  @override
...
class SerialDubbed extends StatefulWidget {
  const SerialDubbed({Key? key}) : super(key: key);

  @override
  State<SerialDubbed> createState() => _SerialDubbedState();
}

class _SerialDubbedState extends State<SerialDubbed> {
  bool saveIcon = false;
  int? _selectedIndex;
  @override
  Widget build(BuildContext context) {
                      ...
                      return Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            //           children: const [
                            //             Text(
                            //               "All the information about the serial page",
                                    ...
                                    child: Stack(
                                      children: [
                                        GestureDetector(
                                          ...
                                          onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>SerialPlayTheme()));},
                                          child: Container(
