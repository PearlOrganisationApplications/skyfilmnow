...
class TurkishSerialsTheme extends StatefulWidget {
  const TurkishSerialsTheme({Key? key}) : super(key: key);

  @override
  State<TurkishSerialsTheme> createState() => _TurkishSerialsThemeState();
}

class _TurkishSerialsThemeState extends State<TurkishSerialsTheme> {
  @override
    ...
    return FutureBuilder<SharedPreferences>(
      ...
      builder:
        ...
        return ChangeNotifierProvider<MyDynamicTheme>.value(
          ...
          child: const TurkishSerialsPage(),
        );
      },
    );
  }
...
class TurkishSerialsPage extends StatefulWidget {
  const TurkishSerialsPage({Key? key}) : super(key: key);

  @override
  State<TurkishSerialsPage> createState() => _TurkishSerialsPage();
}

class _TurkishSerialsPage extends State<TurkishSerialsPage> {
  bool saveIcon = false;
  int? _selectedIndex;
  @override
  Widget build(BuildContext context) {
