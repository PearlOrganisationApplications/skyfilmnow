...
class SerialsGenerTheme extends StatefulWidget {
  const SerialsGenerTheme({Key? key}) : super(key: key);

  @override
  State<SerialsGenerTheme> createState() => _SerialsGenerThemeState();
}

class _SerialsGenerThemeState extends State<SerialsGenerTheme> {
  @override
  Widget build(BuildContext context) { return FutureBuilder<SharedPreferences>(
    future: SharedPreferences.getInstance(),
    builder: (BuildContext context, AsyncSnapshot<SharedPreferences> snapshot) {
      return ChangeNotifierProvider<MyDynamicTheme>.value(
        value: MyDynamicTheme(snapshot.data),
        child: const SerialsGener(),
      );
    },
  );
...
class SerialsGener extends StatefulWidget {
  const SerialsGener({Key? key}) : super(key: key);

  @override
  State<SerialsGener> createState() => _SerialsGenerState();
}

class _SerialsGenerState extends State<SerialsGener> {
  bool saveIcon = false;
  int? _selectedIndex;
