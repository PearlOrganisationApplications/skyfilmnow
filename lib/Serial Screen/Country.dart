...
class SerialsCountryTheme extends StatefulWidget {
  const SerialsCountryTheme({Key? key}) : super(key: key);

  @override
  State<SerialsCountryTheme> createState() => _SerialsCountryThemeState();
}

class _SerialsCountryThemeState extends State<SerialsCountryTheme> {
  @override
...
class SerialsCountry extends StatefulWidget {
  const SerialsCountry({Key? key}) : super(key: key);

  @override
  State<SerialsCountry> createState() => _SerialsCountryState();
}

class _SerialsCountryState extends State<SerialsCountry> {
  bool saveIcon = false;
  int? _selectedIndex;
  @override
  Widget build(BuildContext context) {
