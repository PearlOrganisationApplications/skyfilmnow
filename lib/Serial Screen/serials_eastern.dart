...
class EasternSerialsTheme extends StatefulWidget {
  const EasternSerialsTheme({Key? key}) : super(key: key);

  @override
  State<EasternSerialsTheme> createState() => _EasternSerialsThemeState();
}

class _EasternSerialsThemeState extends State<EasternSerialsTheme> {
  @override
    ...
    return FutureBuilder<SharedPreferences>(
      ...
      builder: (BuildContext context,
        ...
        return ChangeNotifierProvider<MyDynamicTheme>.value(
          ...
          child: const EasternSerialsPage(),
        );
      },
    );
  }
}
class EasternSerialsPage extends StatefulWidget {
  const EasternSerialsPage({Key? key}) : super(key: key);

  @override
  State<EasternSerialsPage> createState() => _EasternSerialsPageState();
}

class _EasternSerialsPageState extends State<EasternSerialsPage> {
  bool saveIcon = false;
  int? _selectedIndex;
  @override
  Widget build(BuildContext context) {
